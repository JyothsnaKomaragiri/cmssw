...
# options.register('outFilename', 'TrackTree',
#$$
    VarParsing.multiplicity.singleton,
...
options.register('usePuppiForFatJets', False,
    VarParsing.multiplicity.singleton,
    VarParsing.varType.bool,
    "Use Puppi for fat jets"
)
options.register('usePuppiForBTagging', True,
#$$
    VarParsing.multiplicity.singleton,
    VarParsing.varType.bool,
...
#$$
options.register('mcGlobalTag', '90X_upgrade2023_realistic_v1',
#$$
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "MC global tag"
...
#$$$$
# options.register('maxdeltaR', 0.4,
#     VarParsing.multiplicity.singleton,
#     VarParsing.varType.float,
#     "maxdeltaR for JP jets (default is 0.3)"
# )
# options.register('maxDistToJetAxis', 0.2,
#     VarParsing.multiplicity.singleton,
#     VarParsing.varType.float,
#     "maxDistToJetAxis for JP jets (default is 0.07)"
# )
# options.register('maxDecayLength', 9.,
#     VarParsing.multiplicity.singleton,
#     VarParsing.varType.float,
#     "maxDecayLength for JP jets (default is 5.0)"
# )
#$$$$
...
options.register('minNumberOfPixelHits', 1,
    VarParsing.multiplicity.singleton,
    VarParsing.varType.int,
...
options.register('jecDBFile', 'PhaseIISummer16_25nsV3', 
#$$$$
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
...
#### Phase-2 MC files
#$$
        '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FCEB8448-98F6-E611-BA63-1866DAEB5D80.root',
#         '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FCF9B156-BDF6-E611-B5E4-FA163E35B16A.root',
#         '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FE1507BE-79FB-E611-8C99-02163E019BF7.root',
#         '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FE3FC89F-98F6-E611-9559-001E67504FED.root',
#         '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FE51B21C-32F8-E611-85F4-ECF4BBE15B60.root',
#         '/store/mc/PhaseIIFall16DR82/TT_TuneCUETP8M1_14TeV-powheg-pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/110000/FE97D96C-58F6-E611-9D50-FA163E3E0557.root'
#$$
#         'file:FCEB8448-98F6-E611-BA63-1866DAEB5D80.root'
#$$
    ]
    if options.runOnData:
        process.source.fileNames = [
...
process.BTauMVAJetTagComputerRecord = cms.ESSource("PoolDBESSource",
   ...
   toGet = cms.VPSet(
       cms.PSet(
           ...
           tag = cms.string('MVAJetTags_Phase2')
       )
   ),
   connect = cms.string('sqlite_fip:RecoBTag/PerformanceMeasurements/data/MVAJetTags_Phase2.db'),
...
#$$$$
#process.btagana.deltaR  	    = cms.double(options.maxdeltaR)
#process.btagana.distJetAxis	    = cms.double(options.maxDistToJetAxis)
#process.btagana.decayLength	    = cms.double(options.maxDecayLength)
#$$$$
...
#$$
### Enable storing CSV Tagging Variables for TagVarExtractor (TVE) to run properly
#
